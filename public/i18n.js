...
(function () {
  ...
  const ZH = {
    ...
    'Brown fringe, blue jacket over a white tee.': '棕色刘海，蓝色外套里面一件白T。',
    'Green tee, jeans, short hair. A person, not a costume.': '绿T恤、牛仔裤、短发。是个人，不是套装。',
    'Long hair down the back, pink top, white trainers.': '长发披到背后，粉色上衣，白球鞋。',
    'Navy uniform, gold badge, peaked cap.': '藏青制服、金色警徽、大檐帽。',
    'The old seeded look — shirt and hair dealt from your name.': '以前那套随机外观——衣服和头发由名字决定。',
    'Rookie': '新人', 'Boy': '男孩', 'Girl': '女孩', 'Police': '警察',
    'Balaclava, goggle band, plate carrier with mag pouches.': '头套、护目镜带、插板背心和弹匣袋。',

...
(function () {
  ...
  const ZH = {
    ...
    'Chill zone · walk up to anyone and press F to duel': '休闲区 · 走到任何人面前按 F 约战',
    'Chill zone · walk up to anyone and tap DUEL to duel': '休闲区 · 走到任何人面前点「约战」',
    '⚔️ Press F to challenge {name} to a 1V1{rest}': '⚔️ 按 F 向 {name} 发起 1V1{rest}',
    '⚔️ Tap DUEL to challenge {name} to a 1V1{rest}': '⚔️ 点「约战」向 {name} 发起 1V1{rest}',
    '(wants a fight!)': '（想打一架！）',
    '⚔️ {area}  {you} you · 🟦 BLUE {b}  🟥 RED {r}  · press F to start': '⚔️ {area}  {you} 你 · 🟦 蓝队 {b}  🟥 红队 {r}  · 按 F 开始',
    '⚔️ {area}  {you} you · 🟦 BLUE {b}  🟥 RED {r}  · tap DUEL to start': '⚔️ {area}  {you} 你 · 🟦 蓝队 {b}  🟥 红队 {r}  · 点「约战」开始',
